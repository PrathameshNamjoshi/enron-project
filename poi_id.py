...
for i in range(len(poi)):
    if poi[i]==1:
        pl.scatter(fraction_from_poi[i],fraction_to_poi[i],c='red',s=50)
    else:
        pl.scatter(fraction_from_poi[i],fraction_to_poi[i],c='green',s=50)
pl.xlabel('Fraction of emails the person received from a POI') 
pl.ylabel('Fraction of emails the person sent to a POI') 
pl.show()
